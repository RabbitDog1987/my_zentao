...
class github extends control
{
	 ...
	 public function __construct($moduleName = '', $methodName = '')
    {
		...
		//$github_t = isset($_SERVER['GITHUB_T'])?$_SERVER['GITHUB_T']:'';
		var_dump($_ENV);
...
*/
	...
	public function callback()
	{
		...
		if(isset($result['access_token']) && $result['access_token']!=''){
			//$_SERVER['GITHUB_T'] = $result['access_token'];
			//$this->server->set('GITHUB_T', $result['access_token']);
			var_dump($_SERVER['GITHUB_T']);
			//var_dump($_ENV['GITHUB_T']);
